...
- Auto entry / TP / SL alerts

- Confidence score (A+ / A / B)
...
import os import time from datetime import datetime from zoneinfo import ZoneInfo
...
def build_trade(symbol: str, trend: str): df = get_data(symbol) if df is None or df.empty or len(df) < 30: return None
